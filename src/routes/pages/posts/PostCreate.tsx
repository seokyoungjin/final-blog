...
export default function PostCreate() {
      ...
      try {
        ...
        if (previewImage !== thumbnail) {
          ...
          const {
            ...
            "https://api.cloudinary.com/v1_1/dzbr9hpuu/image/upload",
            formData
          );
          thumbnail = url;
        }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-8 py-8">
      <title>{`${
        post ? "Modify a post - SULOG" : "Create a post - SULOG"
      }`}</title>
      <h1 className="text-3xl font-bold text-white mb-8">
        Write {post ? "Modifiy" : "New"} Post
      </h1>
